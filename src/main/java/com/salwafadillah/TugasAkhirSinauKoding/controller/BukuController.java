...
public class BukuController {
    ...
    public Response findAllData() {
        ...
        return new Response(data,"Get All Data Buku", HttpStatus.OK) ;
    }
    @PostMapping("/create")
    public Response saveData(@RequestBody BukuDTO param) {

        if (service.save(param) == null) {
            return new Response("Data Buku Tidak Ditemukan", HttpStatus.BAD_GATEWAY);
        }
